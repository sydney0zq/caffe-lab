...
def opts():
    ...
    parser.add_argument("--baseWidth", type=int, default=64, help="ResNext base width", choices=[64, 40, 24, 14, 4])
    parser.add_argument("--cardinality", type=int, default=16, help="ResNext cardinality", choices=[1, 2, 4, 8, 32])
