...
def opts():
    ...
    parser.add_argument("--baseWidth", type=int, default=14, help="ResNext base width", choices=[64, 40, 24, 14, 4])
    parser.add_argument("--cardinalty", type=int, default=8, help="ResNext cardinality", choices=[1, 2, 4, 8, 32])
